...
//Initialized the LCD display
LiquidCrystal_I2C lcd(0x27, 16, 2);

char auth[] = "8KcOt6ZNchtXakRrkOatXpT71HDOUS4M";//Enter your Auth token
char ssid[] = "Galaxy A5194B7";//Enter your WIFI name
char pass[] = "ctr585blr";//Enter your WIFI password
          
BlynkTimer timer;

// Defined the components pins
#define trig D7
#define echo D8
#define LED1 D0
#define LED2 D3
...
void setup() {
  ...
  lcd.init();
  lcd.backlight();
  lcd.command(0x0C); // Turn off cursor
  pinMode(trig, OUTPUT);
  pinMode(echo, INPUT);
  pinMode(LED1, OUTPUT);
  pinMode(LED2, OUTPUT);
